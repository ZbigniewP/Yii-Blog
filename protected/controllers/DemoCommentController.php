...
class DemoCommentController extends Controller
{
	...
	public function actionUpdate()
	{
		...
		$this->render('//comment/update', array('model' => $model));
	}
	...
	{
		$dataProvider = new CActiveDataProvider('DemoComment', array(
			'criteria' => array(
				'with' => 'post',
				'order' => 't.status, t.publishedAt DESC',
			),
		));
		$this->render('//comment/index', array('dataProvider' => $dataProvider));
	}
